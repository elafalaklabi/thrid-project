...
const key = "&appid=88dcd292232a3ee0d58367aad3726dc2&units=imperial";
...
const post = async (url = "", data = {}) => {
  // url here is the post route that was spcified in the server.
...
const updateUI = async () => {
  ...
  try {
    ...
    console.log("the request has failed, try again", error);
  }
};
